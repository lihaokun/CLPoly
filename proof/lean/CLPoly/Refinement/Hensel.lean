  ...
  · rw [dif_pos hleft]
    ...
    · rw [dif_pos hright]
      ...
      rcases strictHenselTreeBuildRecursiveRawIR_succeeds this hcfg h2p hp2
        ...
        ⟨output, houtputRun, houtputFrame, houtputInvariant⟩
...
theorem strictHenselTreeBuildRawIR_succeeds
  ...
  rcases strictHenselTreeBuildRecursiveRawIR_succeeds this hcfg h2p hp2
    ...
    ⟨output, hrun, hframe, hrootInvariant⟩
