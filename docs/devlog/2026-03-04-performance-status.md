...
| P1 GCDHEU 启发式快速路径 | 已完成 | 单变量小系数 3.4-11.7x 加速（A/B 实测） |
...
- **GCDHEU 贡献**（A/B 实测）：小系数场景加速 3.4-11.7x，高阶收益更大；大系数不触发，多变量不走此路径
- **剩余优化重点**: 高阶 → P3 HGCD；CRT 收敛 → P2 增量 content
...
| 优先级 | 模块 | 预期效果 | 适用范围 | 状态 |
|--------|------|---------|---------|------|
| 1 | P1 GCDHEU | ~~小系数 2-5x~~ 实测 3.4-11.7x | 单变量 | ✅ 已完成 |
| 2 | P2 CRT 优化 | 1.2-1.5x | 单/多变量 | 待实施 |
| 3 | P3 HGCD | 高次 (deg>1725) | 单变量 Zp | 待实施 |
