...
LEAN_FILES = (
    ...
    V2_ROOT.parent / "lean" / "CLPoly" / "Generated" / "StrictGCDHGCD.lean",
...
def main() -> None:
    ...
    required = (
        ...
        "hgcdMatQuotientEntry_succeeds",
        "HgcdMatApplyQuotientTotalWorkspace",
        "hgcdMatApplyQuotient_succeeds",
        "HgcdMatMulEntryTotalWorkspace",
        "hgcdMatMulEntry_succeeds",
        "HgcdMatMulLoopTotalWorkspace",
        "hgcdMatMulLoop_succeeds",
        "hgcdMatMul_succeeds",
        "HgcdRecursiveCombineMatrixAfterQuotient",
        "HgcdRecursiveCombineMatrixTotalWorkspace",
        "hgcdRecursiveCombineMatrix_succeeds",
        "HgcdRecursiveFinishAfterReconstruct",
        "HgcdRecursiveFinishTotalWorkspace",
        "hgcdRecursiveFinish_succeeds",
        ...
        "hgcdRecursiveSecondCall_succeeds",
        "HgcdRecursiveAfterSecondTotalWorkspace",
        "hgcdRecursiveFinishStage_succeeds",
        "HgcdRecursiveNonEarlyTotalWorkspace",
        "HgcdRecursiveBodyTotalWorkspace",
        "hgcdRecursiveNonBaseBody_succeeds",
        "HgcdRecursiveInvocationTotalWorkspace",
        "HgcdRecursiveInvocationTotalWorkspaceProviderBelow",
        "hgcdRecursiveCallChecked_succeeds_wf",
        "GcdHgcdLoopEuclidWorkspaceProvider",
        "GcdHgcdDivremWorkspace",
        "GcdHgcdDynamicDivremWorkspaceProvider",
        "GcdHgcdDynamicEuclidWorkspaceProvider",
        "GcdHgcdDynamicHgcdWorkspace",
        "GcdHgcdDynamicHgcdWorkspaceProvider",
        "GcdHgcdInitialHgcdWorkspace",
        "GcdHgcdInitialHgcdWorkspaceProvider",
        "gcdHgcdInitial_hgcd_step_succeeds",
        "hgcdRecursiveBase_succeeds",
        "gcdHgcdLoop_dynamic_divrem_step",
        "gcdHgcdLoop_dynamic_euclid_step",
        "gcdHgcdLoop_divrem_step",
        ...
        "sparse_upoly_zp_to_dense_raw_ir",
        "sparseToDenseWriteLoop_succeeds",
        "sparseToDenseWriteLoop_sameLayout",
        "sparse_upoly_zp_to_dense_raw_ir_succeeds",
        "sparse_upoly_zp_to_dense_raw_ir_valid",
        "slicePolyRep_write_add_monomial",
        "sparsePrefixPoly_coeff_current_eq_zero",
        "sparseToDenseWriteLoop_refines",
        "sparseToDenseWriteLoop_canonical",
        "sparse_upoly_zp_to_dense_raw_ir_refines",
        "sparse_upoly_zp_to_dense_raw_ir_canonical",
        "sparse_upoly_zp_to_dense_raw_ir_canonicalSlice",
        "sparseToDenseWriteLoop_preserves_read",
        "sparseToDenseWriteLoop_leading_read",
        "sparseDenseLength",
        "sparse_upoly_zp_dense_constructor_raw_ir",
        "sparse_upoly_zp_to_dense_raw_ir_rawDense_nonempty",
        "sparse_upoly_zp_to_dense_raw_ir_rawDense_empty",
        "sparse_upoly_zp_dense_constructor_raw_ir_result",
        "DenseGcdRawResult",
        "denseGcdCutoff",
        "dense_upoly_zp_gcd_ordered_raw_ir",
        "dense_upoly_zp_gcd_raw_ir",
        "dense_upoly_zp_gcd_ordered_raw_ir_refines",
        "DenseGcdOrderedReady",
        "dense_upoly_zp_gcd_ordered_raw_ir_refines_of_ready",
        "dense_upoly_zp_gcd_raw_ir_refines",
        "SparseRawDenseRep",
        ...
        "denseToSparseLoop_canonical",
        "dense_upoly_zp_to_upoly_raw_ir_canonical",
        "dense_upoly_zp_to_upoly_raw_ir_result",
        "GcdHgcdRawResult",
        "HgcdGcdLoopLengthDecreases",
        "gcdHgcdLoop",
        "dense_upoly_zp__gcd_hgcd_raw_ir",
        "GcdEuclidRawResult",
