...
int main() {
    ...
    CLPOLY_TEST("crosscheck_ntl_factor_wilkinson_w10");
    {
        ...
        auto ntl_f = crosscheck::clpoly_upoly_to_ntl(w10);
        auto ntl_fac = crosscheck::ntl_factor(ntl_f);
    ...
    CLPOLY_TEST("crosscheck_ntl_factor_wilkinson_w15");
    {
        ...
        auto ntl_f = crosscheck::clpoly_upoly_to_ntl(w15);
        auto ntl_fac = crosscheck::ntl_factor(ntl_f);
    ...
    CLPOLY_TEST("crosscheck_ntl_factor_wilkinson_w20");
    {
        ...
        auto ntl_f = crosscheck::clpoly_upoly_to_ntl(w20);
        auto ntl_fac = crosscheck::ntl_factor(ntl_f);
    ...
    // 旋轮 x^24 - 1
    CLPOLY_TEST("crosscheck_ntl_factor_cyclotomic_x24m1");
    {
        upolynomial_ZZ cyc24({{umonomial(24), ZZ(1)}, {umonomial(0), ZZ(-1)}});
        auto cl_fac = factorize(cyc24);
        auto ntl_f = crosscheck::clpoly_upoly_to_ntl(cyc24);
        auto ntl_fac = crosscheck::ntl_factor(ntl_f);
        auto cl_sorted = normalize_cl_factors(cl_fac);
        auto ntl_sorted = normalize_ntl_factors(ntl_fac);
        CLPOLY_ASSERT(cl_sorted == ntl_sorted);
    ...
    CLPOLY_TEST("crosscheck_ntl_factor_swinnerton_dyer_s3");
    {
        upolynomial_ZZ sd3({
        ...
        auto ntl_f = crosscheck::clpoly_upoly_to_ntl(sd3);
        auto ntl_fac = crosscheck::ntl_factor(ntl_f);
